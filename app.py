...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Kim Đề - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0989 986 055</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Kim Đề - Trường PTDTBT Tiểu học Quảng Nguyên - ĐT: 0989 986 055</div>", unsafe_allow_html=True)
